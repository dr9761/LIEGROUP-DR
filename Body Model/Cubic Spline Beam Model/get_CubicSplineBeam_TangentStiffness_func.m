function CubicSplineBeam_TangentStiffness_Func = ...
...
%%
TangentStiffness = jacobian(Fint,qe);
CubicSplineBeam_TangentStiffness_Func = ...
	casadi.Function('CubicSplineBeam_TangentStiffness_Func', ...
	{qe}, {TangentStiffness}, ...
	{'qe'}, {'TangentStiffness'});
% CubicSplineBeam_Mass_Func = ...
% 	casadi.Function('CubicSplineBeam_Mass_Func', ...
% 	{qe}, {Mass}, ...
% 	{'qe'}, {'Mass'});

function [Mass,Force,Fine,Fint,Fext] = CubicSpline_Mass_FunctionLibrary(...
...
%%
I1_1 = zeros(3);I1_1(1,1) = 1;
I1_2 = zeros(3);I1_2(1,2) = 1;
I1_3 = zeros(3);I1_3(1,3) = 1;

I2_1 = zeros(3);I2_1(2,1) = 1;
I2_2 = zeros(3);I2_2(2,2) = 1;
I2_3 = zeros(3);I2_3(2,3) = 1;

I3_1 = zeros(3);I3_1(3,1) = 1;
I3_2 = zeros(3);I3_2(3,2) = 1;
I3_3 = zeros(3);I3_3(3,3) = 1;
%
...
% 		get_dT_Cardan(Angle_1_x,dAngle_1_x) * T_Angle;
	...
	%%
	Mtra = Mtra + D'*N'*lambda*N*D*w;
	Mrot = Mrot + Tomega'*rhoJ*Tomega*w;
	
	Dtra = Dtra + D'*N'*lambda*N*dDdt*w;
	Drot = Drot + Tomega'*(rhoJ*dTomegadt+skew(omegad)*rhoJ*Tomega)*w;
	%%
	Fextg = Fextg - D'*N'*lambda*g*w;
	
	%%
	Mass_Function_Library = [Mass_Function_Library, ...
		D'*N'*I1_1*N*D*w,		D'*N'*I1_2*N*D*w,		D'*N'*I1_3*N*D*w, ...
		D'*N'*I2_1*N*D*w,		D'*N'*I2_2*N*D*w,		D'*N'*I2_3*N*D*w, ...
		D'*N'*I3_1*N*D*w,		D'*N'*I3_2*N*D*w,		D'*N'*I3_3*N*D*w, ...
		Tomega'*I1_1*Tomega*w,	Tomega'*I1_2*Tomega*w,	Tomega'*I1_3*Tomega*w, ...
		Tomega'*I2_1*Tomega*w,	Tomega'*I2_2*Tomega*w,	Tomega'*I2_3*Tomega*w, ...
		Tomega'*I3_1*Tomega*w,	Tomega'*I3_2*Tomega*w,	Tomega'*I3_3*Tomega*w];
	
	Force_Function_Library = [Force_Function_Library, ...
		TStrain'*I1_1*w,						TStrain'*I1_2*w,						TStrain'*I1_3*w, ...
		TStrain'*I2_1*w,						TStrain'*I2_2*w,						TStrain'*I2_3*w, ...
		TStrain'*I3_1*w,						TStrain'*I3_2*w,						TStrain'*I3_3*w, ...
		D'*N'*I1_1*N*dDdt*dqe*w,				D'*N'*I1_2*N*dDdt*dqe*w,				D'*N'*I1_3*N*dDdt*dqe*w, ...
		D'*N'*I2_1*N*dDdt*dqe*w,				D'*N'*I2_2*N*dDdt*dqe*w,				D'*N'*I2_3*N*dDdt*dqe*w, ...
		D'*N'*I3_1*N*dDdt*dqe*w,				D'*N'*I3_2*N*dDdt*dqe*w,				D'*N'*I3_3*N*dDdt*dqe*w, ...
		Tomega'*I1_1*dTomegadt*dqe*w,			Tomega'*I1_2*dTomegadt*dqe*w,			Tomega'*I1_3*dTomegadt*dqe*w, ...
		Tomega'*I2_1*dTomegadt*dqe*w,			Tomega'*I2_2*dTomegadt*dqe*w,			Tomega'*I2_3*dTomegadt*dqe*w, ...
		Tomega'*I3_1*dTomegadt*dqe*w,			Tomega'*I3_2*dTomegadt*dqe*w,			Tomega'*I3_3*dTomegadt*dqe*w, ...
		Tomega'*skew(omegad)*I1_1*Tomega*dqe*w,	Tomega'*skew(omegad)*I1_2*Tomega*dqe*w,	Tomega'*skew(omegad)*I1_3*Tomega*dqe*w, ...
		Tomega'*skew(omegad)*I2_1*Tomega*dqe*w,	Tomega'*skew(omegad)*I2_2*Tomega*dqe*w,	Tomega'*skew(omegad)*I2_3*Tomega*dqe*w, ...
		Tomega'*skew(omegad)*I3_1*Tomega*dqe*w,	Tomega'*skew(omegad)*I3_2*Tomega*dqe*w,	Tomega'*skew(omegad)*I3_3*Tomega*dqe*w, ...
		-D'*N'*I1_1*g*w,						-D'*N'*I1_2*g*w,						-D'*N'*I1_3*g*w, ...
		-D'*N'*I2_1*g*w,						-D'*N'*I2_2*g*w,						-D'*N'*I2_3*g*w, ...
		-D'*N'*I3_1*g*w,						-D'*N'*I3_2*g*w,						-D'*N'*I3_3*g*w];
end
Mass = Mtra + Mrot;

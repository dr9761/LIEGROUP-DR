function [Mass_Function_Library,Force_Function_Library] = ...
...
%%
I3_1_1 = zeros(3);I3_1_1(1,1) = 1;
I3_1_2 = zeros(3);I3_1_2(1,2) = 1;
I3_1_3 = zeros(3);I3_1_3(1,3) = 1;

I3_2_1 = zeros(3);I3_2_1(2,1) = 1;
I3_2_2 = zeros(3);I3_2_2(2,2) = 1;
I3_2_3 = zeros(3);I3_2_3(2,3) = 1;

I3_3_1 = zeros(3);I3_3_1(3,1) = 1;
I3_3_2 = zeros(3);I3_3_2(3,2) = 1;
I3_3_3 = zeros(3);I3_3_3(3,3) = 1;
%%
I4_1_1 = zeros(4);I4_1_1(1,1) = 1;
I4_1_2 = zeros(4);I4_1_2(1,2) = 1;
I4_1_3 = zeros(4);I4_1_3(1,3) = 1;
I4_1_4 = zeros(4);I4_1_4(1,4) = 1;

I4_2_1 = zeros(4);I4_2_1(2,1) = 1;
I4_2_2 = zeros(4);I4_2_2(2,2) = 1;
I4_2_3 = zeros(4);I4_2_3(2,3) = 1;
I4_2_4 = zeros(4);I4_2_4(2,4) = 1;

I4_3_1 = zeros(4);I4_3_1(3,1) = 1;
I4_3_2 = zeros(4);I4_3_2(3,2) = 1;
I4_3_3 = zeros(4);I4_3_3(3,3) = 1;
I4_3_4 = zeros(4);I4_3_4(3,4) = 1;

I4_4_1 = zeros(4);I4_4_1(4,1) = 1;
I4_4_2 = zeros(4);I4_4_2(4,2) = 1;
I4_4_3 = zeros(4);I4_4_3(4,3) = 1;
I4_4_4 = zeros(4);I4_4_4(4,4) = 1;
%%
q1 = qe(1:numel(qe)/2);
...
%%
Mass_Function_Library = zeros(14,14*18*gaussn);
Force_Function_Library = zeros(14,1*52*gaussn);
%%
for i = 1:gaussn
	x = x_set(i);
	w = w_set(i);
	...
	%%
	Mass_Function_Library(:,14*18*(i-1)+[1:14*9]) = [...
	...
	Mass_Function_Library(:,14*18*(i-1)+[14*9+1:14*18]) = [...

% OptimalControl_TripleJibPendulum
%%
clear; close all; clc;
rng(0);
%% Load Parameter
...
x_min = [-pi;deg2rad(-85);deg2rad(  5);deg2rad(-5);deg2rad(-5); ...
		 -0.1;-0.5;-0.5;deg2rad(-5);deg2rad(-5)];
...
CostParameters.Q = 1*diag([10;10;10;    1;1;1;   0;0;   0;0]);
CostParameters.R = 1e-15*diag([1;1;1]);
CostParameters.Pend = 10*diag([10;10;10;   1;1;1;   1;1;   1;1]);
...
axis(TrajectoryAxes,[-30,30,-30,30,-15,45]);

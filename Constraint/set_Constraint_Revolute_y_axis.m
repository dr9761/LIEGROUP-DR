function [Phi,B,dPhi,Tau] = set_Constraint_Revolute_y_axis(...
...
BJ1J2(5,:) = ...
	[zeros(1,3),-gy'*RJ2'*RJ1*skew(gz),zeros(1,3),-gz'*RJ1'*RJ2*skew(gy)];
...
dBJ1J2dt(5,:) = ...
	[zeros(1,3),gy'*D21*skew(gz),zeros(1,3),gz'*D12*skew(gy)];
%
dBJ1J2dt = dBJ1J2dt';
Tau = dBJ1J2dt' * dqJ;

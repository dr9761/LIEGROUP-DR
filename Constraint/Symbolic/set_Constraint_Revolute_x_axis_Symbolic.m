function [Phi,B,dPhi,Tau] = ...
	set_Constraint_Revolute_x_axis_Symbolic(...
...
BJ1J2(4,:) = ...
	[zeros(1,3),-gx'*RJ2'*RJ1*skew(gy),zeros(1,3),-gy'*RJ1'*RJ2*skew(gx)];
BJ1J2(5,:) = ...
	[zeros(1,3),-gx'*RJ2'*RJ1*skew(gz),zeros(1,3),-gz'*RJ1'*RJ2*skew(gx)];
...
dBJ1J2dt(4,:) = ...
	[zeros(1,3),gx'*D21*skew(gy),zeros(1,3),gy'*D12*skew(gx)];
dBJ1J2dt(5,:) = ...
	[zeros(1,3),gx'*D21*skew(gz),zeros(1,3),gz'*D12*skew(gx)];
%
dBJ1J2dt = dBJ1J2dt';
Tau = dBJ1J2dt' * dqJ;

function [Mass,Force,Fine,Fint,Fext] = ...
	VariableCrossSection_CubicSpline_MassForce(...
...
Le  = L / SegmentQuantity;
%
gaussn = 11;
% x_set = gaussx(0,L,gaussn);
x_set = gaussx((SegmentNr-1)*Le,SegmentNr*Le,gaussn);
w_set = gaussw(gaussn)*Le/2;

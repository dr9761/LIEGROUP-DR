function [NextObs,Reward,IsDone,LoggedSignals] = ...
    StepFunction_DynamicModel(Action,LoggedSignals, ...
	ModelParameter,SolverParameter,Ts,Tf, ...
...
IsDone = Set_IsDone_Condition(Obs,NextObs,Action);
%% Get reward.
Reward = get_Reward(Obs,NextObs,Action);
%%

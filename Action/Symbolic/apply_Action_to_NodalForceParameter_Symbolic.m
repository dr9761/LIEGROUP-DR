function NodalForceParameter = apply_Action_to_NodalForceParameter_Symbolic(...
		...
		switch NodalForceType
			case 'Force'
				NodalForceParameter{NodalForceNr}.NodalForce = ...
					casadi.SX(NodalForceParameter{NodalForceNr}.NodalForce);
				NodalForceParameter{NodalForceNr}.NodalForce(NodalForceIndex) = ...
					ActionValue;
			case 'Moment'
				NodalForceParameter{NodalForceNr}.NodalMoment = ...
					casadi.SX(NodalForceParameter{NodalForceNr}.NodalMoment);

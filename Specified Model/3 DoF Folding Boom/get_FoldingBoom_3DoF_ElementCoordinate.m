function [qb,dqb,Tb,dTb] = get_FoldingBoom_3DoF_ElementCoordinate(...
	q,dq,ModelParameter)
%%
...
R10 = Temp_R4 * get_R([0;-Phi_4_10;0]);
nx10 = R10(:,1);
nz10 = R10(:,3);
...
%% qb
qb = cell(13,1);
qb{1}  = q1;	qb{2}  = q2;	qb{3}  = q3;	qb{4}  = q4;	qb{5}  = q5;
qb{6}  = q6;	qb{7}  = q7;	qb{8}  = q8;	qb{9}  = q9;	qb{10} = q10;
qb{11} = q11;	qb{12} = q12;	qb{13} = q13;
%% dqb
dqb = cell(13,1);

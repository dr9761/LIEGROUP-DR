function DriveForce = get_FoldingBoom_3DoF_ValveControlHydraulicDriveForce(...
	u,qb,Tb,ModelParameter,HydraulicParameter)
%%
ut = u(1);
pL1 = u(2);
pL2 = u(3);
...
alphaL = HydraulicElementParameter{3}.alpha;
AL = HydraulicElementParameter{3}.A;
% Upper Hydraulic Cylinder
alphaU = HydraulicElementParameter{8}.alpha;
AU = HydraulicElementParameter{8}.A;

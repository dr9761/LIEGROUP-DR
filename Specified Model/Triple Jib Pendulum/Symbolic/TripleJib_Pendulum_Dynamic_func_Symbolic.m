function [dx,Mass,Force] = TripleJib_Pendulum_Dynamic_func_Symbolic(x,u, ...
	ModelParameter)
%%
q = x(1:5);
dq = x(6:10);
...
%%
[r0b,Rb,dqb,Tb,dTb] = get_TripleJib_Pendulum_ElementCoordinate_Symbolic(...
	q,dq,ModelParameter);
%%
...
%% Add Drive Force
DriveForce = get_TripleJib_Pendulum_DriveForce_Symbolic(u,Tb);
